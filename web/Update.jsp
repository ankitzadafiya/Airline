        ...
        <table width="100%">
            ...
            <tr height="500px" align="center"><td colspan="4">
                    <form action="updateData.jsp" method="post"><table>
                            ...
                            <option value="Zimbobwe">Zimbabwe</option>
                                        </select></td> </tr>
                         ...
                         <p style="color:white">   <b> Click Here to <a href="ticketreservation.jsp">Insert</a> users Airline Reservation data</b></p>
                                <p style="color:white"> <b>   Click Here to <a href="delete.jsp">Delete</a> users Airline Reservation data</b></p>
